...
urlpatterns = [
    ...
    path('categories-builder/', views.category_builder, name='category_builder'),
    path('subcategories-builder/<int:pk>/', views.subcategory_builder, name='subcategory_builder'),
    path('add-sub-category/<int:category_id>/', views.add_sub_category, name='add_sub_category'),
    path('menu-builder/category/<int:pk>/', views.fooditems_by_category, name='fooditems_by_category'),
    path('edit-subcategory/<int:category_id>/<int:pk>/', views.edit_subcategory, name='edit_subcategory'),
    ...
    #Product 
    path('products/', views.product_list_view, name='vendor_products_list'),
